...
<>
    <section className="relative h-screen  overflow-hidden">
      ...
      <p className='underline'>About Us</p>
        ...
        <h1 className='text-2xl md:text-4xl font-bold mt-4 '>Businesses with Cutting-</h1>
        <h2 className='text-2xl md:text-4xl font-bold  mb-5'>Edge Digital Innovations</h2>
