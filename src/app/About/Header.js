...
const Header = () => {
  ...
  fill
  quality={100}
  className="absolute inset-0 z-0 object-cover sm:h-[50vh] sm:w-full"
  priority
/>
        <div className="relative z-10 flex h-full flex-col justify-center text-white max-w-[90%] md:max-w-[85%] mx-auto px-4">
          ...
          <p className="text-sm md:text-base lg:text-lg">
            We transform ideas into disruptive digital products and 
          </p>
          <p className='text-sm md:text-base lg:text-lg'>strategies to drive growth for Startups, SMBs, and Enterprises.</p>
